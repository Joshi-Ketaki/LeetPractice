/*
Read this: https://leetcode.com/problems/design-sql/solutions/4336949/o-1-don-t-focus-on-implementation/?envType=study-plan-v2&envId=amazon-spring-23-high-frequency
...
public:
    ...
    void deleteRow(string name, int rowId) {
        //mp[name][rowId].erase(mp[name][rowId].begin(), mp[name][rowId].end());
    }
    
    string selectCell(string name, int rowId, int columnId) {
        return mp[name][rowId-1][columnId-1];
    }
};
